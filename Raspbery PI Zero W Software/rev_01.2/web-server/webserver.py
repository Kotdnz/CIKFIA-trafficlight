...
lights = {"RED":"OFF","YELLOW":"OFF","YELOFF":"OFF","GREEN":"OFF","RED1":"OFF","GREEN1":"OFF","GREEN2":"OFF","OFF":"ON","PIT":"OFF","LAST":"OFF"}
...
def action(changeColor, action):
 try:
   ...
   if changeColor in lights:
	...
	if changeColor != "YELLOW" and changeColor != "YELOFF" :
		allOFF()
	else :
